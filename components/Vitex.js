...
function Vitex({props}) {
  ...
  let description = TREES[5].description;
  ...
  <View style={styles.container}>
   ...
   <Image source={require('../images/vitex.jpg')} style={styles.image} alt="Creek Willow tree" />
   ...
   <Button 
      ...
      color='#6A006A'
      accessibilityLabel="Add Vitex to Shopping List"
      onPress={() => { dispatch(addPlantToFavorites("Vitex")); confirmationAdded()} }
      />  
  ...
  <Button 
      ...
      color='#708A70'
      accessibilityLabel="Remove Vitex from Shopping List"
      style={styles.button}
      onPress={() => { dispatch(removePlantFromFavorites("Vitex")); confirmationRemoved()} }
      />
