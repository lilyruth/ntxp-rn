...
function Redbud({props}) {
  ...
  let description = TREES[3].description;
  ...
  <View style={styles.container}>
   ...
   <Image source={require('../images/redbud.jpg')} style={styles.image} alt="Creek Willow tree" />
   ...
   <Button 
      ...
      color='#6A006A'
      accessibilityLabel="Add Redbud to Shopping List"
      onPress={() => { dispatch(addPlantToFavorites("Redbud")); confirmationAdded()} }
      />  
  ...
  <Button 
      ...
      color='#708A70'
      accessibilityLabel="Remove Redbud from Shopping List"
      style={styles.button}
      onPress={() => { dispatch(removePlantFromFavorites("Redbud")); confirmationRemoved()} }
      />
