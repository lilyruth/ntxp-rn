...
function TopGunRose({props}) {
  ...
  let description = TREES[6].description;
  ...
  <View style={styles.container}>
   ...
   <Image source={require('../images/topgun.jpg')} style={styles.image} alt="Creek Willow tree" />
   ...
   <Button 
      ...
      color='#6A006A'
      accessibilityLabel="Add Top Gun Rose to Shopping List"
      onPress={() => { dispatch(addPlantToFavorites("Top Gun Rose")); confirmationAdded()} }
      />  
  ...
  <Button 
      ...
      color='#708A70'
      accessibilityLabel="Remove Top Gun Rose from Shopping List"
      style={styles.button}
      onPress={() => { dispatch(removePlantFromFavorites("Top Gun Rose")); confirmationRemoved()} }
      />
